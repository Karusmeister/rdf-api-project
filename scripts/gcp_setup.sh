...
echo ""
echo "Next steps:"
echo "  1. Upload your local DB:"
echo "     CLOUDSDK_ACTIVE_CONFIG=rdf-project gsutil cp data/scraper.duckdb gs://$DATA_BUCKET/seed/scraper.duckdb"
echo "  2. Bootstrap the VM:"
echo "     CLOUDSDK_ACTIVE_CONFIG=rdf-project gcloud compute ssh $VM_NAME --zone=$ZONE"
echo "     # Then run: bash /opt/rdf-api-project/scripts/vm_bootstrap.sh"
